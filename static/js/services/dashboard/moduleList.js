...
function moduleList(){
  ...
  return [
    ...
    {application: 'AP', alias: 'AP' ,Available: 'yes',Permission: 'yes', Insert: 'no', Update: 'no', Delete: 'no', url:'apchq.html', color: 'cornflowerblue', img:'dist/css/images/gisredDashboard_images/icono_ap.png'},
